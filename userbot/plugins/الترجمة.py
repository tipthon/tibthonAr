...
import requests
import json
from userbot.helpers.functions.functions import translate
...
@iqthon.iq_cmd(pattern="(الترجمة الفورية|الترجمه الفوريه|ايقاف الترجمة|ايقاف الترجمه)")
...
@iqthon.iq_cmd(pattern="لغة الترجمة")
